...
class TestExternalReferenceMessage(unittest.TestCase):
    def test_external_reference_message_generator_explicit(self):
        ...
        self.assertEqual(externalReference.name, name, "Names should match")
        self.assertEqual(
            externalReference.description, description, "Descriptions should match"
        )

        self.assertEqual(externalReference.url, url, "URLs should match")
        self.assertEqual(
            externalReference.external_id, external_id, "External ids should match"
        )
        self.assertEqual(
            externalReference.reference_id, reference_id, "Reference ids should match"
        )
    ...
    def test_external_reference_message_generator_implicit(self):
        ...
        self.assertEqual(externalReference.name, name, "Names should match")
        self.assertEqual(
            externalReference.description, None, "Descriptions should be none"
        )

        self.assertEqual(externalReference.url, None, "URLs should be none")
        self.assertEqual(
            externalReference.external_id, None, "External ids should be none"
        )
        self.assertEqual(
            externalReference.reference_id, None, "Reference ids should be none"
        )
